...
export const machines: Machine[] = [
  { id: "MQ-001", code: "MQ-001", name: "Trator John Deere 6110J",          model: "6110J",        type: "Trator",          clientId: "CL-01", client: "Fazenda Santa Clara", areaId: "AR-01", area: "Talhão Norte",  operatorId: "USR-OP-1", operator: "Carlos Mendes",   status: "em alerta", score: 82, level: "alto",  lastAlert: "Velocidade acima do recomendado", lastUpdate: "há 8 min" },
...
export const operations: Operation[] = [
  { id: "OP-1001", machineId: "MQ-001", machine: "MQ-001", operatorId: "USR-OP-1", clientId: "CL-01", areaId: "AR-01", area: "Talhão Norte",  type: "Trabalho no campo",       scheduledAt: "07:12", start: "07:12", duration: "3h 42m", status: "Em andamento", score: 82, factors: ["RF-05", "RF-06"], recommendationId: "RC-01" },
